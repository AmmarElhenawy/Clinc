                ...
                <div class="col-lg-12 col-md-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form id="doctorForm" action="{{ route('doctors.store') }}" method="post" enctype="multipart/form-data" autocomplete="off">
                                {{ csrf_field() }}
                                <div class="row">
                                    <div class="col">
                                        ...
                                        {{-- <input type="hidden" id="doctor_full_name" value="{{ $doc->doctor_full_name }}"> --}}
