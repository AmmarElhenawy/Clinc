                    ...
                    <form action="" method="post" enctype="multipart/form-data" autocomplete="off">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" id="diet_plan" name="Diet_plan"
                                    value="{{ $patientRecord->diet_plan }}" readonly>
                            </div>
                        </div>
                        <br><br><br>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="checkbox" class="form-control" id="fasting_blood_sugar" name="Fasting_blood_sugar"
                                    value="1" {{ $checked = isset($patientRecord->fasting_blood_sugar) && $patientRecord->fasting_blood_sugar == 1 ? 'checked' : '' }} disabled>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="checkbox" class="form-control" id="post_meal_blood_sugar" name="Post_meal_blood_sugar"
                                    value="1" {{ $patientRecord->post_meal_blood_sugar == 1 ? 'checked' : '' }} disabled>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="checkbox" class="form-control" id="hba1c" name="Hba1c"
                                    value="1" {{ $checked = isset($patientRecord->hba1c) && $patientRecord->hba1c == 1 ? 'checked' : '' }} disabled>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="checkbox" class="form-control" id="kidney_function_tests" name="Kidney_function_tests"
                                    value="1" {{ $checked = isset($patientRecord->kidney_function_tests) && $patientRecord->kidney_function_tests == 1 ? 'checked' : '' }} disabled>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="checkbox" class="form-control" id="retinal_examination" name="Retinal_examination"
                                    value="1" {{ $checked = isset($patientRecord->retinal_examination) && $patientRecord->retinal_examination == 1 ? 'checked' : '' }} disabled>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="checkbox" class="form-control" id="ecg" name="Ecg"
                                    value="1" {{ $checked = isset($patientRecord->ecg) && $patientRecord->ecg == 1 ? 'checked' : '' }} disabled>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input type="checkbox" class="form-control" id="numbness" name="Numbness"
                                    value="1" {{ $checked = isset($patientRecord->numbness) && $patientRecord->numbness == 1 ? 'checked' : '' }} disabled>
                                <label for="inputName" class="control-label">تنميل </label>
                            </div>
                            <div class="col">
                                <input type="hidden" class="form-control" name="Burning_sensation" value="0">
                                <input type="checkbox" class="form-control" id="burning_sensation" name="Burning_sensation"
                                    value="1" {{ $checked = isset($patientRecord->burning_sensation) && $patientRecord->burning_sensation == 1 ? 'checked' : '' }} disabled>
                                <label for="inputName" class="control-label"> حرقان </label>
                            </div>
                            <div class="col">
                                <input type="hidden" class="form-control" name="Tingling" value="0">
                                <input type="checkbox" class="form-control" id="tingling" name="Tingling"
                                    value="1" {{ $checked = isset($patientRecord->tingling) && $patientRecord->tingling == 1 ? 'checked' : '' }} disabled>
                                <label for="inputName" class="control-label">شكشكة</label>
                            </div>
                            <div class="col">
                                <input type="hidden" class="form-control" name="Cold_extremities" value="0">
                                <input type="checkbox" class="form-control" id="cold_extremities" name="Cold_extremities"
                                    value="1" {{ $checked = isset($patientRecord->cold_extremities) && $patientRecord->cold_extremities == 1 ? 'checked' : '' }} disabled>
                            ...
                            <div class="col">
                                ...
                                <input type="checkbox" class="form-control" id="muscle_cramps" name="Muscle_cramps"
                                    value="1" {{ $checked = isset($patientRecord->muscle_cramps) && $patientRecord->muscle_cramps == 1 ? 'checked' : '' }} disabled>
                        ...
                        <div class="d-flex justify-content-center">
                            <a href="{{route('prescription',$patientRecord->id)}}" class="btn btn-primary"> اضافه روشته</a>
                        </div>
