...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('patientsRecord.store') }}" method="post" enctype="multipart/form-data"
                        autocomplete="off">
                        {{ csrf_field() }}
                        {{-- 1 --}}
                        ...
                        <div class="row">
                            <div class="col">
                                <label for="inputName" class="control-label">الاسم الاول </label>
                                <input type="text" class="form-control" id="First_name" name="First_name"
                                    title="يرجي ادخال الاسم الاول " required>
                            </div>
                            <div class="col">
                                <label for="inputName" class="control-label">الاسم الاخير </label>
                                <input type="text" class="form-control" id="Last_name" name="Last_name"
                                    title="يرجي ادخال الاسم الاخير " required>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" id="Phone_number" name="Phone_number"
                                    title="يرجي ادخال رقم التليفون " required>
                            </div>
                            <div class="col">
                                <label for="inputName" class="control-label">السن </label>
                                <input type="text" class="form-control" id="Age" name="Age" title="يرجي ادخال السن  "
                                    required>
                            </div>
                        </div>
                            {{-- 3 --}}
                        ...
                        <h3 class="card-title">بيانات المريض</h3>
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <input type="checkbox" class="form-control" id="fasting_blood_sugar" name="Fasting_blood_sugar"  value="1">
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <input type="checkbox" class="form-control" id="post_meal_blood_sugar" name="Post_meal_blood_sugar"  value="1">
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <input type="checkbox" class="form-control" id="hba1c" name="Hba1c"  value="1">
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <input type="checkbox" class="form-control" id="kidney_function_tests" name="Kidney_function_tests"  value="1">
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <input type="checkbox" class="form-control" id="retinal_examination" name="Retinal_examination"  value="1">
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <input type="checkbox" class="form-control" id="ecg" name="Ecg"  value="1">
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    ...
                                    <input type="checkbox" class="form-control" id="muscle_cramps" name="Muscle_cramps"  value="1">
